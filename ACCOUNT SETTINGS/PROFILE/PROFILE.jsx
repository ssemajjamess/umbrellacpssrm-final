...
<head>
    ...
    <meta charset="utf-8" />
    <title ng-init='title = "Edit Profile"' ng-bind="title + ' &middot; AccuLynx'">Edit Profile &middot; AccuLynx</title>
...
<script type="text/javascript">
    ...
    <link href="https://static.alstatic.net/stylebundle/Settings-c9dda5f32dd00714.css" rel="stylesheet"/>
...
<header id="vue-header" class="webapp-header" data-bootstrap="{&quot;Tasks&quot;:0,&quot;TasksDueToday&quot;:0,&quot;TasksOverdue&quot;:0,&quot;Appointments&quot;:0,&quot;Reminders&quot;:0,&quot;RemindersToday&quot;:0,&quot;AtMes&quot;:16,&quot;AtMeFiltersAllowed&quot;:true,&quot;CompanyUserID&quot;:&quot;2bde0f37-77ca-4733-9b4e-aaca2078a0fd&quot;}">
    <ax-app>
        ...
        <!--help modals-->
        <ax-modal v-model="showSubmitAnIdeaModal" :component="submitAnIdeaModalView" :data="{'ViewAllIdeasURL': 'http://feedback.acculynx.com/forums/243621-general-feedback/?sso=yKNHDwZQdVXYO2TtEC5e8El1b6Oy1VlDCOhh%2f0Tr7R91OR2QJHXLAsQGiP%2fIUjymVANUIDPLiIQMWKpaZGN%2bAo0YyFRRzxcSJ7kkEtSlX47tpehNqxp22Cn%2b1lis4HuDLI6%2f1crq9vx4Lw%2fYx38waxOTOuZ%2b%2blNIpAzU%2fpD3bvlluxVg1ILoB2GTieHnTVha%2fg8dy5y2x8o4xWBv3NNVmg%3d%3d'}"></ax-modal>
...
<div class="size-containment profile" id="container" ng-controller="ProfileCtrl as profileCtrl" ng-init="profileCtrl.initializeUser('2c4293df-d186-4320-8b5a-ffca32c1e064')">
    <nav class="sub-nav">
    <div class="nav-profile-meta clearfix">
        <img class="avatar" ng-src="{{profileCtrl.TempURI ? profileCtrl.TempURI + 'NewSmall.png' : null}}" />
        <p class="muted">Signed in as</p>
        <p ng-cloak class="users-name">{{profileCtrl.User.FirstName}} {{profileCtrl.User.LastName}}</p>
    </div>
    <div class="mobile-nav-button">
        <button ng-click="showMobileNav = !showMobileNav">
            Menu
            <svg class="icon-chevron-single chevron-down"><use xlink:href="/Images/icon-sprite.svg#icon-chevron-single"></use></svg>
        </button>
    </div>
    <ul class="sub-nav-list" ng-class="{'open': showMobileNav}">
        <li class="link">
            <a href="/profile/edit">
                <svg class="icon icon-person"><use xlink:href="/Images/icon-sprite.svg#icon-person"></use></svg>
                Profile
            </a>
        </li>
        <li class="link">
            <a href="/profile/settings">
                <svg class="icon icon-cog"><use xlink:href="/Images/icon-sprite.svg#icon-cog"></use></svg>
                Settings
            </a>
        </li>
            <li class="link">
                <a href="/profile/calendarsettings">
                    <svg class="icon icon-calendar-empty"><use xlink:href="/Images/icon-sprite.svg#icon-calendar-empty"></use></svg>
                    Calendar
                </a>
            </li>
                                    <li class="link">
            ...
            <li class="link">
                <a href="/accountsettings/">
                    <svg class="icon icon-arrow"><use xlink:href="/Images/icon-sprite.svg#icon-arrow"></use></svg>
    ...
    <div class="settings-content">
        <section class="padded widget" ng-init="showProfile = true">
            ...
            <div class="widget-body" ng-show="showProfile" ng-cloak>
                <div>
                    <label class="settings-label" for="firstName">Your Name:</label>
                    <input name="firstName" type="text" id="firstName" data-type="text" ng-model="profileCtrl.User.FirstName" tabindex="1" required class="profile-settings__input" />
                    <input name="lastName" type="text" id="lastName" data-type="text" ng-model="profileCtrl.User.LastName" tabindex="2" required class="profile-settings__input" />
                    <p ng-if="profileCtrl.HasError('FullName')" class="small f--red email-message">{{profileCtrl.GetError('FullName')}}</p>
                </div>
                <div>
                    <label for="displayName" class="settings-label">Display Name:</label>
                    <input name="displayName" type="text" id="displayName" data-type="text" ng-model="profileCtrl.User.DisplayName" tabindex="3" required class="profile-settings__input" />
                    <p ng-if="profileCtrl.HasError('DisplayName')" class="small f--red email-message">{{profileCtrl.GetError('DisplayName')}}</p>
                </div>
                <div class="m-b--xxl">
                    <label for="initials" class="settings-label">Initials:</label>
                    <input name="initials" type="text" id="initials" maxlength="5" data-type="text" ng-model="profileCtrl.User.Initials" tabindex="4" class="profile-settings__input" />
                </div>
                <div class="m-b--xxl">
                    <hr class="hr" />
                </div>
                ...
                <p class="muted m-b--xxl">Enter your default contact information for all locations below:</p>
                <div>
                    <label for="emailAddress" class="settings-label">Sign In Email:</label>
                    <input id="emailAddress" type="email" name="emailAddress" class="width-2x profile-settings__input" ng-model="profileCtrl.User.LoginEmail" tabindex="5" />
                    <p class="muted small email-message">This email address is also used to sign in to AccuLynx</p>
                </div>
                <div>
                    <label for="mainPhone" class="settings-label">Main Phone:</label>
                    <input name="mainPhone" type="tel" id="mainPhone" ui-mask="(999) 999-9999" ui-options="{clearOnBlur: false}" placeholder="(xxx) xxx-xxxx" ng-model="profileCtrl.User.Phone" tabindex="6" class="profile-settings__input" />
                    <p class="muted small email-message">This is the phone number that will appear on printed material and automations</p>
                </div>
                <div class="m-b--md">
                    <label for="cellPhone" class="settings-label">Cell Phone:</label>
                    <input name="cellPhone" type="tel" id="cellPhone" ui-mask="(999) 999-9999" ui-options="{clearOnBlur: false}" placeholder="(xxx) xxx-xxxx" ng-model="profileCtrl.User.MobilePhone" tabindex="7" class="profile-settings__input" />
                    <p class="muted small email-message">This is where text message notifications will be sent to</p>
                    <a ng-if="profileCtrl.HasTextMessagingFeature && profileCtrl.User.MobilePhone" class="email-message" href="/profile/settings?section=editingCommunicationPreferenceInfo">Manage automated text message preferences</a>
                </div>
                <div>
                    <label for="meetingLink" class="settings-label">Meeting Link:</label>
                    <input name="meetingLink" type="url" id="meetingLink" ng-model="profileCtrl.User.VideoConferenceUrl" placeholder="https://" tabindex="8" class="width-2x profile-settings__input" />
                    <p class="muted small email-message">Your video conferencing or calendar scheduling link</p>
                </div>
                ...
                <div class="clearfix profile-photo">
                    <div class="photo-button-row clearfix">
                        <label class="settings-label">Profile Photo:</label>
                        <button type="button" class="btn-link select-image-btn" ng-click="profileCtrl.showPreview()" tabindex="9"><span show-mobile="false">Upload</span><span show-mobile="true" ng-cloak>Submit Picture</span></button>
                        <button id="takePictureWebcam" type="button" class="btn-link" ng-click="profileCtrl.showWebcam()" tabindex="10" show-mobile="false">Take Photo</button>
                        <span class="muted small">(optional)</span>
                    </div>
                    <div ng-cloak class="photo-placeholder" ng-click="profileCtrl.showPreview()" ng-hide="profileCtrl.webcam || profileCtrl.photoPreview">
                        <img ng-if="!profileCtrl.ProfilePictureURI" src="/Images/QuickStart/profile-pic.png" alt="" />
                        <img class="avatar-preview" ng-if="profileCtrl.ProfilePictureURI" ng-src="{{profileCtrl.ProfilePictureURI}}New.png" alt="" />
                    </div>
                    <div id="image-cropper" ng-show="profileCtrl.photoPreview">
                        <div class="cropit-image-preview" id="profile-picture-preview"></div>
                        <input type="range" class="cropit-image-zoom-input" />
                        <!-- The actual file input will be hidden -->
                        <input type="file" accept="image/*" class="cropit-image-input" />
                    </div>
                    <div class="webcam" ng-class="{'conceal': !profileCtrl.webcam}">
                        <div id="my_camera" style="width:150px; height:150px;"></div>
                    </div>
                    <div class="instructions">
                        <button ng-class="{'conceal': !profileCtrl.webcam}" id="snapPicture" type="button" class="btn btn-text" ng-click="profileCtrl.showPreview()">Snap Picture</button>
                        <p>Your photo will be shown next to your AccuLynx activity like messages, tasks, and new sales.</p>
                        <p>If no photo is added, we will show your initials... which is not nearly as fun.</p>
                    </div>
                </div>
                    <div class="flex flex-start-start">
                        <label for="bio" class="settings-label">Bio:</label>
                        <div class="settings--bio width-2x">
                            <textarea id="bio" name="bio" class="width-2x profile-settings__input" maxlength="1000" rows="3" ng-model="profileCtrl.User.Bio" tabindex="11"></textarea>
                            <p style="margin-left:5px;" class="muted small email-message">
                                This may be used to provide a biographical summary about you in automated emails. The bio has a limit of 1000 characters.
                            </p>
                        </div>
                    </div>

                <p class="f--12 f--red f--right m-b--lg" ng-if="profileCtrl.Errors.length">Please fix the errors above.</p>
                <div class="f--right">
                    <button id="saveButton" ng-click="profileCtrl.PostUser()" ng-disabled="profileCtrl.SaveInProgress" class="button-v3--solid-blue button-v3--sm" tabindex="12">{{profileCtrl.SaveInProgress ? "Saving..." : "Save"}}</button>
                </div>
            </div>
        </section>
    </div>
...
<script>
    ...
    <script>
            var siteVersion = '2009';
    </script>
    <script src="https://static.alstatic.net/scriptbundle/Profile-636a27ef7ac1441c.js" crossorigin integrity='sha512-0MAwwE/hNRWqeXzceW3zJi/zFtFewDES44CBbl4LMfNYtJHHx1pu5plE6PsmJHGIbu+lVNhQeFO+nWlq0lOUlw=='></script>

    <script>
        acculynx.angular.addDependency("ngResource");
    </script>
    <script src="/Scripts/WebcamJS/webcam.js"></script>
    <script src="/Scripts/Cropit/jquery.cropit.js"></script>
    <script src="/Scripts/Cropit/exif.js"></script>
    ...
    <script>
        ...
        $('.select-image-btn, .photo-placeholder').click(function () {
            $('.cropit-image-input').click();
        });

        $("#takePictureWebcam").click(function (event) {
            var scope = angular.element(document.getElementById("container")).scope();
            scope.profileCtrl.NewProfilePicture = false;
            scope.profileCtrl.webcam = true;

            $('#image-cropper').cropit('imageSrc', null);
        ...
        $("#snapPicture").click(function (event) {
            Webcam.snap(function (data_uri) {
                var scope = angular.element(document.getElementById("container")).scope();
                scope.profileCtrl.ProfilePictureURI = data_uri;
                scope.profileCtrl.NewProfilePicture = true;
                $('#image-cropper').cropit('imageSrc', data_uri);
            });
        ...
        $('#saveButton').click(function (event) {
            ...
            var imageDataLarge = $('#image-cropper').cropit('export',
                {
                    type: 'image/png'
                });

            scope.profileCtrl.User.ProfilePicture = imageDataLarge;
            return true;
        });
