...
<head>
    ...
    <meta charset="utf-8" />
    <title ng-init='title = "Manage Insurance Companies"' ng-bind="title + ' &middot; AccuLynx'">Manage Insurance Companies &middot; AccuLynx</title>
...
<header id="vue-header" class="webapp-header" data-bootstrap="{&quot;Tasks&quot;:0,&quot;TasksDueToday&quot;:0,&quot;TasksOverdue&quot;:0,&quot;Appointments&quot;:0,&quot;Reminders&quot;:0,&quot;RemindersToday&quot;:0,&quot;AtMes&quot;:16,&quot;AtMeFiltersAllowed&quot;:true,&quot;CompanyUserID&quot;:&quot;2bde0f37-77ca-4733-9b4e-aaca2078a0fd&quot;}">
    <ax-app>
        ...
        <!--help modals-->
        <ax-modal v-model="showSubmitAnIdeaModal" :component="submitAnIdeaModalView" :data="{'ViewAllIdeasURL': 'http://feedback.acculynx.com/forums/243621-general-feedback/?sso=yKNHDwZQdVXYO2TtEC5e8El1b6Oy1VlDCOhh%2f0Tr7R91OR2QJHXLAsQGiP%2fIUjymVANUIDPLiIQMWKpaZGN%2bAo0YyFRRzxcSJ7kkEtSlX47tpehNqxp22Cn%2b1lis4HuDLI6%2f1crq9vx4Lw%2fYx38waxOTOuZ%2b%2blNIpAzU%2fpD3bvn6BFamCQsnkDuCEkfNmgQzBXmEOm94jdrKL1%2fhRGrMEA%3d%3d'}"></ax-modal>
...
<div ng-controller="InsuranceCompanyCtrl as ctrl">
                ...
                <section class="padded widget">
                    <div class="flex flex-start-center">
                        <div class="input-checkbox account-settings__refinement-col" tabindex="1">
                            <input class="input-checkbox__input" name="active" type="checkbox" id="insuranceEnabled" ng-model="ctrl.InsuranceEnabled" ng-change="ctrl.ToggleInsurance()">
                            <label class="input-checkbox__label--horizontal" for="insuranceEnabled">Enable tracking of insurance companies</label>
                        </div>
                    </div>
                </section>
                <section class="padded widget">
                    ...
                    <div class="widget-body">
                        <p>
                            The insurance companies you list will be selectable for jobs by all users at this location.
                        </p>
                    </div>
                </section>
                <div ng-show="ctrl.InsuranceEnabled">
                    ...
                    <header class="widget-header">
                        <h2 class="widget-title">
                            <svg class="icon icon-default">
                                <use xlink:href="/Images/icon-sprite.svg#icon-clipboard"></use>
                            </svg>
                            Insurance Companies
                        </h2>
                    </header>
                    <div class="widget-body">
                        ...
                        <ul class="account-settings__tag-listing">
                            <li class="account-settings__tag flex flex-between-center" ng-class="{'account-settings__tag--edit': insurance.isEditing}" ng-repeat="insurance in ctrl.FilteredList | filter: ctrl.filterText | orderBy: ['Name']">
                                <div class="flex flex-start-center">
                                    <div class="input-checkbox" style="margin-right: 12px;">
                                        <input id="checkbox-input-{{$index}}" ng-model="insurance.Status" ng-change="ctrl.SaveInsuranceCompany(insurance, 'edit', true)" class="input-checkbox__input" type="checkbox" checked="checked" />
                                        <label for="checkbox-input-{{$index}}" class="input-checkbox__label--horizontal"></label>
                                    </div>
                                    <span ng-show="!insurance.isEditing">{{insurance.Name}}</span>
                                </div>
                                <input class="account-settings__tag__name" type="text" ng-model="ctrl.CurrentInsuranceCompany.Name" value="{{insurance.Name}}" ng-show="insurance.isEditing" />
                                <div class="flex-noshrink flex flex-start-start" ng-show="!insurance.isEditing && insurance.Name.toLowerCase() != 'other'">
                                    <button class="account-settings__tag__action" ng-click="ctrl.addOrEditInsuranceCompany(insurance)">
                                        <svg class="icon icon-pencil">
                                            <use xlink:href="/Images/icon-sprite.svg#icon-pencil"></use>
                                        </svg>
                                    </button>
                                    <button ng-disabled="insurance.IsUsed" class="account-settings__tag__action" ng-click="ctrl.openDeleteModal(insurance)" title="{{insurance.IsUsed ? 'Cannot Delete. Currently in use.' : 'Delete'}}">
                                        <svg class="icon icon-trash-can">
                                            <use xlink:href="/Images/icon-sprite.svg#icon-trash-can"></use>
                                        </svg>
                                    </button>
                                </div>
                                <div class="flex-noshrink flex flex-start-start" ng-if="insurance.Name.toLowerCase() == 'other'">
                                    System Default
                                </div>
                                <div class="flex-noshrink" ng-show="insurance.isEditing">
                                    <button class="account-settings__tag__action button-solid button" ng-click="ctrl.SaveInsuranceCompany(insurance, 'edit')" ng-disabled="ctrl.isSaving">
                                        Save
                                    </button>
                                    <button class="account-settings__tag__action button-clear button" ng-click="insurance.isEditing = false" ng-disabled="ctrl.isSaving">
                                        Cancel
                                    </button>
                                </div>
                            </li>
                        ...
                        <div class="p-y--md" ng-show="!ctrl.addingInsuranceCompany">
                            <button class="button-v3--sm button-v3--text-blue f--16 m-t--md" tabindex="4" ng-click="ctrl.addOrEditInsuranceCompany(null)">
                                <svg width="14" height="14" class="m-r--md ax-svg ax-svg--plus"><use xlink:href="/Images/icon-sprite.svg#icon-plus"></use></svg>
                                Add Another
                            </button>
                        </div>                       
                        <div class="account-settings__refinements flex flex-between-center" ng-show="ctrl.addingInsuranceCompany">
                            <div>
                                <span>Add</span>
                                <input id="js-adding-item-name" class="account-settings__tag__name" type="text" ng-model="ctrl.CurrentInsuranceCompany.Name">
                            </div>
                            <div class="flex-noshrink">
                                <button class="account-settings__tag__action button-solid button" ng-click="ctrl.SaveInsuranceCompany(ctrl.CurrentInsuranceCompany, 'add')" ng-disabled="ctrl.isSaving">Save</button>
                                <button class="account-settings__tag__action button-clear button" ng-click="ctrl.addingInsuranceCompany = !ctrl.addingInsuranceCompany" ng-disabled="ctrl.isSaving">Cancel</button>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="overlay" ng-if="ctrl.isDeleting" ng-cloak>
        <div class="overlay__content flex flex-col" role="dialog">
            <div class="flex flex-col flex-grow">
                <header class="overlay__header flex flex-center-center">
                    <h2 class="overlay__heading">Delete "{{ctrl.CurrentInsuranceCompany.Name}}" Insurance Company</h2>
                </header>
                ...
                <footer class="overlay__footer flex flex-between-center">
                    ...
                    <button class="button button-solid button-danger button-uppercase-small overlay__button-180" ng-click="ctrl.DeleteInsuranceCompany(ctrl.CurrentInsuranceCompany)">Delete</button>
                </footer>
            </div>
        </div>
    </div>
