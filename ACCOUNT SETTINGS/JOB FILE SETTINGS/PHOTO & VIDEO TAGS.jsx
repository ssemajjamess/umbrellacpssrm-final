...
<head>
    ...
    <meta charset="utf-8" />
    <title ng-init='title = "Manage Photo Tags"' ng-bind="title + ' &middot; AccuLynx'">Manage Photo Tags &middot; AccuLynx</title>
...
<header id="vue-header" class="webapp-header" data-bootstrap="{&quot;Tasks&quot;:0,&quot;TasksDueToday&quot;:0,&quot;TasksOverdue&quot;:0,&quot;Appointments&quot;:0,&quot;Reminders&quot;:0,&quot;RemindersToday&quot;:0,&quot;AtMes&quot;:16,&quot;AtMeFiltersAllowed&quot;:true,&quot;CompanyUserID&quot;:&quot;2bde0f37-77ca-4733-9b4e-aaca2078a0fd&quot;}">
    <ax-app>
        ...
        <!--help modals-->
        <ax-modal v-model="showSubmitAnIdeaModal" :component="submitAnIdeaModalView" :data="{'ViewAllIdeasURL': 'http://feedback.acculynx.com/forums/243621-general-feedback/?sso=yKNHDwZQdVXYO2TtEC5e8El1b6Oy1VlDCOhh%2f0Tr7R91OR2QJHXLAsQGiP%2fIUjymVANUIDPLiIQMWKpaZGN%2bAo0YyFRRzxcSJ7kkEtSlX47tpehNqxp22Cn%2b1lis4HuDLI6%2f1crq9vx4Lw%2fYx38waxOTOuZ%2b%2blNIpAzU%2fpD3bvmIWPCQnIEHmkbtjqA0crP3vyDu2WsTaIjweJwhr5lx8w%3d%3d'}"></ax-modal>
...
<div ng-controller="PhotoTagsCtrl as ctrl" ng-init="ctrl.init('PhotoTags')">
        ...
        <div class="flex-grow account-settings__main-content" style="max-width: 720px">
            <section class="padded widget">
                ...
                <header class="widget-header">
                    <h2 class="widget-title">
                        <svg class="icon icon-default">
                            <use xlink:href="/Images/icon-sprite.svg#icon-tag"></use>
                        </svg>
                        Photo & Video Tags
                    </h2>
                </header>
                <div class="widget-body">
                    <p>
                        Create a list of tags you can add to your new and old photos or videos.
                    </p>
                    ...
                    <ul class="account-settings__tag-listing">
                        <li class="account-settings__tag flex flex-between-center" ng-class="{'account-settings__tag--edit': tag.isEditing}" ng-repeat="tag in ctrl.FilteredList | filter: ctrl.filterText | orderBy: ['TagName']">
                            <div class="flex flex-start-center">
                                <div class="input-checkbox" style="margin-right: 12px;">
                                    <input id="checkbox-input-{{$index}}" ng-model="tag.Active" ng-change="ctrl.SavePhotoTags(tag, 'editStatus', true)" class="input-checkbox__input" type="checkbox" checked="checked" />
                                    <label for="checkbox-input-{{$index}}" class="input-checkbox__label--horizontal"></label>
                                </div>
                                <span ng-show="!tag.isEditing">{{tag.TagName}}</span>
                            </div>
                            <input class="account-settings__tag__name" type="text" ng-model="ctrl.currentTag.TagName" value="{{tag.TagName}}" ng-show="tag.isEditing" maxlength="50" />
                            <div class="flex-noshrink" ng-show="!tag.isEditing">
                                <button class="account-settings__tag__action" ng-click="ctrl.addOrEditTag(tag)">
                                    <svg class="icon icon-pencil">
                                        <use xlink:href="/Images/icon-sprite.svg#icon-pencil"></use>
                                    </svg>
                                </button>
                                <button class="account-settings__tag__action" ng-click="ctrl.openDeleteModel(tag)">
                            ...
                            <div class="flex-noshrink" ng-show="tag.isEditing">
                                <button class="account-settings__tag__action button-solid button" ng-click="ctrl.SavePhotoTags(tag, 'edit')" ng-disabled="ctrl.isSaving || (tag.TagName == ctrl.currentTag.TagName)">
                                    Save
                                </button>
                                <button class="account-settings__tag__action button-clear button" ng-click="tag.isEditing = false" ng-disabled="ctrl.isSaving">
                                    Cancel
                                </button>
                            </div>
                        </li>
                    ...
                    <div class="p-y--md" ng-show="!ctrl.addingTag">
                        <button class="button-v3--sm button-v3--text-blue f--16 m-t--md" tabindex="4" ng-click="ctrl.addOrEditTag(null)">
                            <svg width="14" height="14" class="m-r--md ax-svg ax-svg--plus"><use xlink:href="/Images/icon-sprite.svg#icon-plus"></use></svg>
                            Add Another
                        </button>
                    </div>                   
                    <div class="account-settings__refinements flex flex-between-center" ng-show="ctrl.addingTag">
                        <div>
                            <span>Add</span>
                            <input id="js-adding-item-name" class="account-settings__tag__name" type="text" ng-model="ctrl.currentTag.TagName" maxlength="50">
                        </div>
                        <div class="flex-noshrink">
                            <button class="account-settings__tag__action button-solid button" ng-click="ctrl.SavePhotoTags(ctrl.currentTag, 'add')" ng-disabled="ctrl.isSaving">Save</button>
                            <button class="account-settings__tag__action button-clear button" ng-click="ctrl.addingTag = !ctrl.addingTag" ng-disabled="ctrl.isSaving">Cancel</button>
                        </div>
                    </div>
                </div>
            </section>
    ...
    <div class="overlay" ng-if="ctrl.isDeleting" ng-cloak>
        <div class="overlay__content flex flex-col" role="dialog">
            <div class="flex flex-col flex-grow">
                <header class="overlay__header flex flex-center-center">
                    <h2 class="overlay__heading">Delete "{{ctrl.currentTag.TagName}}" Tag</h2>
                </header>
                <div class="overlay__body" style="text-align: center;">
                    <p>Are you sure you want to delete this tag?</p>
                    <p style="font-size: smaller; margin-top: 20px; margin-bottom: 20px;">(Previously tagged items will no longer have this tag)</p>
                </div>
                <footer class="overlay__footer flex flex-between-center">
                    ...
                    <button class="button button-solid button-danger button-uppercase-small overlay__button-180" ng-click="ctrl.DeletePhotoTags(ctrl.currentTag)">Delete</button>
                </footer>
            </div>
        </div>
    </div>
